...
void vector_resize() {
  std::cout << "\e[95mresize: \e[0m" << std::endl;
  ft::vector<int> myvector;
...
void vector_capacity() {
  std::cout << "\e[95mcapacity: \e[0m" << std::endl;
  ft::vector<int> myvector;
...
void vector_reserve() {
  std::cout << "\e[95mreserve: \e[0m" << std::endl;
...
void vector_at() {
  std::cout << "\e[95mat: \e[0m" << std::endl;
...
void vector_front() {
  std::cout << "\e[95mfront: \e[0m" << std::endl;
  ft::vector<int> myvector;
...
void vector_back() {
  std::cout << "\e[95mback: \e[0m" << std::endl;
  ft::vector<int> myvector;
...
///Modifiers:
void vector_assign() {
  std::cout << "\e[95massign: \e[0m" << std::endl;
  ft::vector<int> first;
...
void vector_push_back() {
  std::cout << "\e[95mpush_back: \e[0m" << std::endl;
  ft::vector<int> myvector;
  int myint;
...
void vector_pop_back() {
  std::cout << "\e[95mpop_back: \e[0m" << std::endl;
  ft::vector<int> myvector;
  int sum (0);
